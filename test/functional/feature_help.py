...
"""Verify that starting nudid with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nudid with -h for help text")
        ...
        self.log.info("Start nudid with -version for version information")
