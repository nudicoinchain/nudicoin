...
* nudi.conf: contains configuration settings for nudid or nudi-qt
* nudid.pid: stores the process id of nudid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by nudid or nudi-qt
