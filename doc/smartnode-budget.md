...
Format: ```mngovernance prepare proposal-name url payment-count block-start nudi-address monthly-payment-nudi```
...
Format: ```mngovernance submit proposal-name url payment-count block-start nudi-address monthly-payment-nudi fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using nudi.conf setup)
