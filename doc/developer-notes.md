...
- [Development guidelines](#development-guidelines)
    - [General Nudi Core](#general-nudi-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
([`valgrind.supp`](https://github.com/nudichain/nudi/blob/master/contrib/valgrind.supp))
...
$ valgrind -v --leak-check=full src/nudid -printtoconsole
```
...
- Try not to overload methods on argument type. E.g. don't make `getblock(true)` and `getblock("hash")`
  ...
  - *Rationale*: This is impossible to use with `nudi-cli`, and can be surprising to users.
...
- Add every non-string RPC argument `(method, idx, name)` to the table `vRPCConvertParams` in `rpc/client.cpp`.
  ...
  - *Rationale*: `nudi-cli` and the GUI debug console use this table to determine how to
