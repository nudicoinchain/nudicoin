...
#ifndef FSOCIETY_ARITH_UINT256_H
#define FSOCIETY_ARITH_UINT256_H
...
public:
     ...
     *
     * Nudi only uses this "compact" format for encoding difficulty
...
#endif // FSOCIETY_ARITH_UINT256_H
