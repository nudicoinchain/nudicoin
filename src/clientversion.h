...
#error Client version information missing: version is not defined by nudi-config.h or in any other way
#endif
...
/**
 * nudid-res.rc includes this file, but it cannot cope with real c++ code.
