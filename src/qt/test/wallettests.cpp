...
//
//     src/qt/test/test_nudi-qt -platform xcb      # Linux
//     src/qt/test/test_nudi-qt -platform windows  # Windows
//     src/qt/test/test_nudi-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: nudi:")) != -1);
