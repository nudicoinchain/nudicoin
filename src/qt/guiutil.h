...
namespace GUIUtil
{
    ...
    // Parse "nudi:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load nudi specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a nudi specific theme is activated (light/dark).*/
