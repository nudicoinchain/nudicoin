...
/** Utility functions used by the Nudi Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "fsociety:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load fsociety specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a fsociety specific theme is activated (light/dark).*/
