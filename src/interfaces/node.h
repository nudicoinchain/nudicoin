...
//! Interface for the src/evo part of a nudi node (nudid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a nudi node (nudid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a nudi node (nudid process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a nudi node (nudid process).
class Node
{
public:
    virtual ~Node() {}
