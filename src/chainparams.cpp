...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    // Print out the new genesis block details
...
{
    const char* pszTimestamp = "[NUDI] We are nudi. We are finally free. A world that belong to us again. [2024]";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0008ac817801e43863d2c3fd53e4d3690536f01a938ac6199ab354a74e81bc92"); // 0
        ...
        //FindMainNetGenesisBlock(1678810092, 0x20001fff, "main");
...
//        }
        ...
        chainTxData = ChainTxData{
            1678810092,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        //FindMainNetGenesisBlock(1678810092,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1678810092, 1584, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6607b016d5eb1a9dc374c25af8f353cd84cce8b8aa60e9627562135628434337"));
        assert(genesis.hashMerkleRoot == uint256S("0x4c230a37cc3633079058a414a5d17bfcb2c0b15cf6e56a41ceff85771b7acd68"));
        ...
        chainTxData = ChainTxData{
            1678808945, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
