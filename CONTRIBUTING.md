Contributing to Nudi Core
============================

The Nudi Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/fsocietychain/fsociety/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Nudi Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Nudi
Network Protocol consensus changes.

Whether a pull request is merged into Nudi Core rests with the project merge
...
Patches that change Nudi consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nudi consensus, it must have been
...
The review process is normally fairly responsive on the Nudi Core repository, however
...
The project leader is the release manager for each Nudi Core release.
